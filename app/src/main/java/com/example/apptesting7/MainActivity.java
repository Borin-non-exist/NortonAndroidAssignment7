package com.example.apptesting7;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    private DatePickerDialog.OnDateSetListener onDateSetListener = ((view, year1, month1, dayOfMonth) -> {
        calLiveday(year1, month1, dayOfMonth);
    });
    ...
    private void calLiveday(int year1, int month1, int dayOfMonth) {
        ...
        textlive.setText("Up time:" + liveDay);
    }
    ...
    public void onTime (){
        ...
        timePickerDialog = new TimePickerDialog(MainActivity.this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                textlive.setText(hourOfDay + ":" + minute);
            }
        }, hour,mid, true);
